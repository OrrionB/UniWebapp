    ...
    return (
      <div>
        <div class="sectionBorder" id="aboutSection">
          ...
          the twelve different classes, and select one that takes your fancy. Then use our generator tool to learn more about your character. Remember to sign up and login if you want to save your character! <br /> Will 
